...
#     path('submit-details/', views.submit_details, name='submit_details'),
      path('company/membership/', views.membership_form_view, name='membership_form_api'),
      path('college/membership/', views.membership_form_view1, name='membership_form_api'),
      path('company/advertisement/', views.advertisement_form_view, name='advertisement_form_api'),
      path('college/advertisement/', views.advertisement_form_view1, name='advertisement_form_api'),
]
